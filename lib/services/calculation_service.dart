...
class CalculationService {
  ...
  static const double _metToKcalRunning =
      1.0; // MET value for running per minute per kg
  static const double _metToKcalWalking =
      0.7; // MET value for walking per minute per kg
  ...
  static double? calculateBMI({
    ...
    if (heightCm == null ||
        ...
        heightCm <= 0 ||
        weightKg <= 0) {
      return null; // Cannot calculate BMI with invalid input
    }
